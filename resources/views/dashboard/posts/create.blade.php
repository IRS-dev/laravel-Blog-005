...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title m-b-0">Create New Posts</h5>
                </div>
                <div class="card">
                    <form class="form-horizontal" method="post" action="/dashboard/posts" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            {{-- Title --}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input  name="slug" required type="text" class="form-control " id="slug" placeholder="Slug" >
                                    @error('slug')
                                    <div>
                                        <span class="text-danger">{{ $message }}</span>
                                    </div>
                            ...
                            {{-- Body Post --}}
                            <div class="form-group row">
                                <label for="body" class="col-sm-3 text-right control-label col-form-label">Message</label>
                                <div class="col-sm-9">
