...
<head>
    ...
    <title>Dashboard IRS-BLOG</title>
    <!-- Custom CSS -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item {{ Request::is('dashboard/posts*') ? 'active' : '' }}"> <a class=" {{ Request::is('dashboard/posts*') ? 'active' : '' }} sidebar-link waves-effect waves-dark sidebar-link" href="/dashboard/posts" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">My Post</span></a></li>
                    </ul>
                </nav>
